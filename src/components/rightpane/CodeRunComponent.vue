<template>
    ...
    <t-tabs :value="TabValue" :placement="placement" @change="handlerChange" @dblclick="resize">
      <t-tab-panel value="first" >
        <template #label> <t-icon name="measurement-1" class="tabs-icon-margin" /> 测试 </template>
       <div class="runTab">
      ...
      <t-tab-panel value="second">
        <template #label> <t-icon name="calendar" class="tabs-icon-margin" /> 结果 </template>
...
/* 获取 Tabs 位置 */
const placement = inject<Ref<string>>("TestRunTabsPlacement")
