<template>
    ...
    >
      <t-tab-panel value="first">
        <template #label> <t-icon name="book" class="tabs-icon-margin" /> 题目 </template>
       <QuestionDetails></QuestionDetails>
      </t-tab-panel>
      <t-tab-panel value="second">
        <template #label> <t-icon name="book-open" class="tabs-icon-margin" /> 题解 </template>
        <p style="padding: 25px">
          题解
        </p>
      </t-tab-panel>
      <t-tab-panel value="third">
        <template #label> <t-icon name="time" class="tabs-icon-margin" /> 提交记录 </template>
        <p style="padding: 25px">
          提交记录
        </p>
      </t-tab-panel>
      <t-tab-panel value="forest">
        <template #label> <t-icon name="sticky-note" class="tabs-icon-margin" /> 笔记 </template>
